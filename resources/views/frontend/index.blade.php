...
<div class="body-wrapper">
                ...
                <div class="row">
                    <div class="col">
                        <div class="site-logo-wrap">
                            <div class="site-logo">
                                <a href="/"><img src="{{asset ('user/img/logo3.png') }}" alt="Logo"></a>
                            </div>
                        </div>
                    </div>
    ...
    <div id="ltn__utilize-mobile-menu" class="ltn__utilize ltn__utilize-mobile-menu">
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            <div class="ltn__utilize-menu-head">
                <div class="site-logo">
                    <a href="index.html"><img src="{{asset ('user/img/logo3.png') }}" alt="Logo"></a>
                </div>
    ...
    <div class="ltn__slider-area ltn__slider-4 position-relative">
        <div class="ltn__slide-one-active----- slick-slide-arrow-1----- slick-slide-dots-1----- arrow-white----- ltn__slide-animation-active">
            ...
            <video autoplay muted loop id="myVideo">
                <source src="{{asset ('user/media/4.mp4') }}" type="video/mp4">
            </video>
                            ...
                            <div class="col-lg-12 align-self-center">
                                <div class="slide-item-info">
                                    <div class="slide-item-info-inner ltn__slide-animation">
                                        <h6 class="slide-sub-title white-color animated">Selamat Datang</h6>
                                        <h1 class="slide-title text-uppercase white-color animated ">Wirausaha <br>  Merdeka</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="ltn__product-area ltn__product-gutter pt-115 pb-70">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2 text-center">
                        <h1 class="section-title">PRODUK UMKM</h1>
                    </div>
                </div>
            </div>
            <div class="row ltn__tab-product-slider-one-active--- slick-arrow-1">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item ltn__product-item-3 text-left">
                        <div class="product-img">
                            ...
                            <div class="product-badge">
                                <ul>
                                    <li class="sale-badge">Rp. {{$data->formatted_harga}}</li>
                                </ul>
                            </div>
                            <div class="product-hover-action">
                                <ul>
                                    <li>
                                        <a href="#" title="Quick View" data-toggle="modal" data-target="#quick_produk_modal">
                                            <i class="far fa-eye"></i>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div class="product-info">
                            {{-- <div class="product-ratting">
                                <ul>
                                    <li><a href="#">Rp. {{$data->harga}}</a></li>
                                </ul>
                            </div> --}}
                            <h2 class="product-title"><a href="#" title="Quick View" data-toggle="modal" data-target="#quick_produk_modal_{{$data->id}}">{{$data->umkm['nama_umkm']}}</a></h2>
                            <div class="product-price">
    ...
    <!-- MODAL AREA START (Quick UMKM Modal) -->
    
    <!-- MODAL AREA END -->

    <!-- MODAL AREA START (Quick Produk Modal) -->
    <div class="ltn__modal-area ltn__quick-view-modal-area">
        <div class="modal fade" id="quick_produk_modal_{{ $data->id }}" tabindex="-1">
